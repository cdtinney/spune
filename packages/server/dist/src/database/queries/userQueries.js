...
exports.findUserBySpotifyId = findUserBySpotifyId;
exports.updateUserByRefreshToken = updateUserByRefreshToken;
...
async function findUserBySpotifyId(spotifyId) {
  const result = await db_1.pool.query('SELECT * FROM users WHERE spotify_id = $1 LIMIT 1', [
    spotifyId,
  ]);
